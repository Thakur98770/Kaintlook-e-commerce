    ...
    <div style={{ maxWidth: 700, margin: "0 auto", padding: "30px 20px", fontFamily: "'Work Sans', sans-serif" }}>
      ...
      {order.status === "cancelled" ? (
        ...
        <div style={{ display: "flex", justifyContent: "space-between", margin: "40px 0", position: "relative" }}>
          ...
          {STAGES.map((stage, i) => (
            <div key={stage} style={{ position: "relative", zIndex: 2, textAlign: "center", flex: 1 }}>
              <div style={{
              ...
              <span style={{ fontSize: 11.5, textTransform: "capitalize", color: i <= currentIndex ? "#1B1B1B" : "#9C998F" }}>{stage}</span>
            </div>
          ))}
        </div>
      )}
